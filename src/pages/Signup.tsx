      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto bg-chess-dark border border-[rgba(255,255,255,0.12)] rounded-lg p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-chess-text-light">Create an Account</h1>
            <p className="text-gray-400 mt-2">Join the SmartChess community</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-chess-text-light">Full Name</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-chess-text-light">Confirm Password</FormLabel>
                    <FormControl>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
                        <Input 
                  ...
                  <FormItem className="flex flex-row items-start space-x-2 space-y-0">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel className="text-sm text-gray-400">
                        I agree to the{" "}
                        <Link to="/terms" className="text-chess-accent hover:underline">
                          Terms of Service
                        </Link>{" "}
                        and{" "}
                        <Link to="/privacy" className="text-chess-accent hover:underline">
                          Privacy Policy
                        </Link>
                      </FormLabel>
                      <FormMessage />
              ...
              <div className="text-center mt-6">
                <p className="text-gray-400">
                  ...
                  <Link to="/login" className="text-chess-accent hover:underline">
                    Sign in
                  </Link>
                </p>
              </div>
